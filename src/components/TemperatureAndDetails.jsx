  ...
  return (
    <div>
        ...
        <div className="flex flex-row items center justify-center space-x-2 text-white text-sm py-3">
            ...
            <UilSunset />
            <p className="font-light">Set: <span className="font-medium ml-1">08:00 PM</span></p>
            <UilArrowUp />
            <p className="font-light">High: <span className="font-medium ml-1">36°</span></p>
            <UilArrowDown />
            <p className="font-light">Low: <span className="font-medium ml-1">20°</span></p>
        </div>
    </div>
  )
}
